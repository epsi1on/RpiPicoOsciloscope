 ...
 static partial class BitmapContextExtensions
    {
        ...
        public static void LoadFromByteArray(this BitmapContext context, byte[] buffer, int offset, int count)
        {
        ...
        /// <param name="buffer">The color buffer as byte ARGB values.</param>
        /// <returns>The WriteableBitmap that was passed as parameter.</returns>
        public static void LoadFromByteArray(this BitmapContext context, byte[] buffer, int count)
        {
            LoadFromByteArray(context, buffer, 0, count);
        }
        ...
        /// <param name="buffer">The color buffer as byte ARGB values.</param>
        /// <returns>The WriteableBitmap that was passed as parameter.</returns>
        public static void FromByteArray(this BitmapContext context, byte[] buffer)
        {
            LoadFromByteArray(context, buffer, 0, buffer.Length);
        }
