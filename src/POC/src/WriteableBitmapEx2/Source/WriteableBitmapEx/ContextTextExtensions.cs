 ...
 static partial class BitmapContextExtensions
    {
        ...
        public static void FillText(this BitmapContext context, FormattedText formattedText, int x, int y, Color color)
        {
            var _textGeometry = formattedText.BuildGeometry(new System.Windows.Point(x, y));
            FillGeometry(context, _textGeometry, color);
        }
        ...
        /// <param name="color">the color.</param>
        public static void FillGeometry(BitmapContext context, Geometry geometry, Color color)
        {

            if (geometry is GeometryGroup gp)
            {
                foreach (var itm in gp.Children)
                    FillGeometry(context, itm, color);
            }
            else if (geometry is PathGeometry pg)
            {
                ...
                context.FillPolygonsEvenOdd(polygons.ToArray(), color);
            }
        ...
        /// <param name="y">The y-coordinate of the text origin</param>
        /// <param name="color">the color.</param>
        public static void DrawText(this BitmapContext context, FormattedText formattedText, int x, int y, Color col)
        {
            var _textGeometry = formattedText.BuildGeometry(new System.Windows.Point(x, y));
            DrawGeometry(context, _textGeometry, col);
        }
        ...
        public static void DrawTextAa(this BitmapContext context, FormattedText formattedText, int x, int y, Color color, int thickness)
        {
            var _textGeometry = formattedText.BuildGeometry(new System.Windows.Point(x, y));
            DrawGeometryAa(context, _textGeometry, color, thickness);
        }
        ...
        /// <param name="geometry">The geometry to be rendered</param>
        /// <param name="color">the color.</param>
        private static void DrawGeometry(BitmapContext bmp, Geometry geometry, Color col)
        {
        ...
        private static void DrawGeometryAa(BitmapContext bmp, Geometry geometry, Color col, int thickness)
        {
