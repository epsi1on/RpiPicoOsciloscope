 ...
 static partial class BitmapContextExtensions
    {
        ...
        public static void Blit(this BitmapContext context, Rect destRect, BitmapContext source, Rect sourceRect, BlendMode blendMode)
        {
            Blit_(context, destRect, source, sourceRect, Colors.White, blendMode);
        }
        ...
        /// <param name="source">The source WriteableBitmap.</param>
        /// <param name="sourceRect">The rectangle that will be copied from the source to the destination.</param>
        public static void Blit(this BitmapContext context, Rect destRect, BitmapContext source, Rect sourceRect)
        {
            Blit_(context, destRect, source, sourceRect, Colors.White, BlendMode.Alpha);
        }
        ...
        /// <param name="blendMode">The blending mode <see cref="BlendMode"/>.</param>
        public static void Blit(this BitmapContext context, Point destPosition, BitmapContext source, Rect sourceRect, Color color, BlendMode blendMode)
        {
            var destRect = new Rect(destPosition, new Size(sourceRect.Width, sourceRect.Height));
            Blit_(context, destRect, source, sourceRect, color, blendMode);
        }
        ...
        /// <param name="blendMode">The blending mode <see cref="BlendMode"/>.</param>
        internal static void Blit_(this BitmapContext context, Rect destRect, BitmapContext source, Rect sourceRect, Color color, BlendMode blendMode)
        {
            if (color.A == 0)
            {
                return;
            ...
            var srcContext = source;
            var destContext = context;
        ...
        public static void BlitRender(this BitmapContext bmp, BitmapContext source, bool shouldClear = true, float opacity = 1f, GeneralTransform transform = null)
        {
