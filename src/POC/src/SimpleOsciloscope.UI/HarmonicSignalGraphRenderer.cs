...
namespace SimpleOsciloscope.UI
{
    ...
    public class HarmonicSignalGraphRenderer : IScopeRenderer
    {
        ...
        private void DrawYGrids(RgbBitmap bmp, int minY, int maxY)
        {
            var trsY = OneDTransformation.FromInOut(maxY, minY, Margin, bmp.Height - Margin);
            ...
            {
                var y = ((maxY - minY) * 1.0 / count) * ii;

                var yp = trsY.Transform(y);

                var maxX = bmp.Width - Margin;
            ...
            {
                bmp.SetPixel(Margin, i, r, g, b);
                bmp.SetPixel(bmp.Width - Margin, i, r, g, b);
            }
