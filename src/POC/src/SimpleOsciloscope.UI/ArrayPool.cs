...
namespace SimpleOsciloscope.UI
{
    public static class ArrayPool
    {
        public class Pooll<T> where T : struct
        {
            ...
            public void Return(T[] arr)
            {
                ...
                lock (Buffer)
                {
                    for (var i = 0; i < Buffer.Count; i++)
                    {
                        if (object.ReferenceEquals(Buffer, arr))
        ...
        {
            var log = System.Math.Floor(System.Math.Log(a, 2));
        ...
        public static Complex[] Complex(int lengh)
        {
            //Nearest(ref lengh);
            //return ArrayPool<bool>.Shared.Rent(lengh);
            //return new bool[lengh];
        ...
        public static double[] Double(int lengh)
        {
            //Nearest(ref lengh);
        ...
        public static int[] Int32(int lengh)
        {
            //Nearest(ref lengh);
